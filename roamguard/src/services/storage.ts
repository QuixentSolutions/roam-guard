...
export async function loadSettings(): Promise<AppSettings> {
  const [enabled, message, triggerMode, skipContacts, logReplies, twoFactorApiKey] =
    await AsyncStorage.multiGet([
      K.ENABLED, K.MESSAGE, K.TRIGGER_MODE, K.SKIP_CONTACTS, K.LOG_REPLIES, K.TWOFACTOR_APIKEY,
    ]);
